...
```{r echo=T, eval=TRUE, message=FALSE}
vec = c("hello", "world")
TexRow(vec, dec = 1, surround = c("{\\color{blue} %s}", "\\frac{%s}{2}"))
```
...
The final command produced the table [here](https://github.com/setzler/textab/blob/main/inst/example3.pdf).
