...
See [this article](https://setzler.github.io/textab/articles/Numerics.html) about formatting numbers. You can also run the following command in R to see the available formatting options:
...
For more information about `TexMidrule`, run the following command:
...
For more information about `TexSave`, run the following command:
...
The final command produced the PDF table [here](https://github.com/setzler/textab/blob/main/inst/example3.pdf).
